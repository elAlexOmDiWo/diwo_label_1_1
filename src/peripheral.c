...
//
//#define BT_UUID_DIWO_LABEL_VAL BT_UUID_128_ENCODE(0x00001523, 0x1212, 0xefde, 0x1523, 0x785feabcd123)
//
...
//  BT_DATA_BYTES(BT_DATA_UUID128_ALL, BT_UUID_DIWO_LABEL_VAL),
//};
//
...
enum bt_label_send_status {
  /** Send notification enabled. */
  bt_label_send_status_ENABLED,
  /** Send notification disabled. */
  bt_label_send_status_DISABLED,
};
...
struct bt_nus_cb {
  ...
  /** @brief Send state callback.
	 ...
	 */
  void (*send_enabled)(enum bt_label_send_status status);
};
